...
toe_dir = "data/toeplitz_quadratic_incre_9"
...
adaptive_df = ddply(summary_adaptive_single, .(b, s, lam1Type, method, design), 
                    summarise, r = mean(r), coverage = mean(coverage))
...
save_list = c( "summary_volume_stein_single", "summary_adaptive_single")
save(list = save_list, file = 'quadratic_incre_9.Rdata')
